...
# # Initialize the memory manager with default 50 blocks of 64 bytes each
# manager = MemoryManager(total_blocks= 25)
# manager.display_memory()

# # Define files to be allocated
# file1 = {"name": "File1", "size": 2}  # 2 blocks
# file2 = {"name": "File2", "size": 4}  # 4 blocks
# file3 = {"name": "File3", "size": 20}  # 4 blocks

# # Allocate memory contiguously
# alloc1 = manager.allocate(file1, 'contiguous')  # Request 2 blocks for "File1"
# print(f"Allocated '{file1['name']}' contiguously at index: {alloc1}")

# # Allocate memory using linked allocation
# alloc2 = manager.allocate(file2, 'linked')  # Request 4 blocks for "File2"
# print(f"Allocated '{file2['name']}' using linked allocation starting at index: {alloc2}")
# manager.display_memory()
...
# # Deallocate memory
# manager.deallocate(alloc1, file1["size"], 'contiguous')
# print(f"\nMemory State after deallocation of '{file1['name']}' (contiguous):")

# # Allocate memory using linked allocation
# alloc3 = manager.allocate(file3, 'linked')  # Request 4 blocks for "File2"
# print(f"Allocated '{file3['name']}' using linked allocation starting at index: {alloc3}")
# manager.display_memory()

# Deallocate memory
# manager.deallocate(alloc3, file3["size"], 'linked')
# print(f"\nMemory State after deallocation of '{file3['name']}' (linked):")
# manager.display_memory()